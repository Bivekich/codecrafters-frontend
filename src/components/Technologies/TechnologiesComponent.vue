  ...
  .boxes {
    ...
    .border-gradient {
      ...
      .box-vue {
        ...
        img { width: 90px }
        -webkit-mask-image: linear-gradient(-80deg, rgba(255, 255, 255, 0.9) 10%, #ffffff 30%, rgba(255, 255, 255, 0.9) 90%);
      ...
      .box-express {
        ...
        img { width: 85px }
        -webkit-mask-image: linear-gradient(-90deg, rgba(255, 255, 255, 0.9) 10%, #ffffff 50%, rgba(255, 255, 255, 0.9) 90%);
      ...
      .box-mongodb {
        ...
        img { height: 85px }
        -webkit-mask-image: linear-gradient(-70deg, rgba(255, 255, 255, 0.9) 10%, #ffffff 70%, rgba(255, 255, 255, 0.9) 90%);
